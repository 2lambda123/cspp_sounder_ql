...
def argument_parser_image():
    ...
    help_strings['bounding_lat'] = """The minimum/maximum latitude to plot for the polar """ \
            """projections. Plot ranges are\n[abs(bounding_lat),90],[-90,-1*abs(bounding_lat)] for """ \
            """npstere,spstere projections\nrespectively. [default: {}]""".format(defaults["bounding_lat"])
    help_strings['extent'] = """Longitude and latitude limits """ \
            """[*lonmin*, *lonmax*, *latmin*, *latmax*]\nof the projection extent."""
    ...
    parser_dicts['extent'] = {
        ...
        'help': help_strings['extent'] if is_expert else argparse.SUPPRESS
    }
